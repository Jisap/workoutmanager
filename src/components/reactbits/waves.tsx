...
class Noise {
  ...
  constructor(seed = 0) {
    ...
    this.p = [
      ...
      199, 106, 157, 184, 84, 204, 176, 115, 121, 50, 45, 127, 4, 150, 254, 138, 236, 205, 93, 222, 114, 67, 29, 24,
...
export function Waves({
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 left-0 rounded-full w-[0.5rem] h-[0.5rem] bg-blue-500/40"
        style={{
